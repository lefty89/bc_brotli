# -*- coding: utf-8 -*-
#
# Bugcluster Brotli documentation build configuration file, created by
# TYPO3 extension sphinx on Thu, 17 Mar 2016 19:31:59 +0100.
#
...
project = u'Bugcluster Brotli'
copyright = u'2016, Lefty'
...
htmlhelp_basename = 'bc_brotlidoc'
...
latex_documents = [
    ('Index', 'bc_brotli.tex', u'Bugcluster Brotli',
     u'Lefty', 'manual'),
]
...
pdf_documents = [
    ('Index', 'bc_brotli', u'Bugcluster Brotli',
     u'Lefty'),
]
...
texinfo_documents = [
    ('Index', 'bc_brotli', u'Bugcluster Brotli',
     u'Lefty', 'Bugcluster Brotli', 'One line description of project.',
     'Miscellaneous'),
]
